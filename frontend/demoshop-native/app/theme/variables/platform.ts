...
export default {
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#F8F8F8' : 'rgba(255,255,255, 0.5)',
  ...
  // loading
  skeletonBackgroundColor: '#edebed',

  //layout
  squereSize: 4,
  getSize(number: number) {
    return number * this.squereSize;
  },

  //tabMenu
  tabMenuBg: '#fff',
  tabMenuActiveIconColor: '#3F51B5',
  tabMenuInactiveIconColor: '#D9D7D9',
};
